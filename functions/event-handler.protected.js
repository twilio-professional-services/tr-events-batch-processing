...
const WorkerAttributesUpdated = require(Runtime.getFunctions()['handlers/workerAttributesUpdated']
  .path);
const WorkerCreated = require(Runtime.getFunctions()['handlers/workerCreated'].path);
const TaskQueueCreated = require(Runtime.getFunctions()['handlers/taskQueueCreated'].path);
const TaskQueueExpressionUpdated = require(Runtime.getFunctions()[
  'handlers/taskQueueExpressionUpdated'
].path);
